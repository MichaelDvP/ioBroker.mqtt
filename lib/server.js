    ...
    function startServer(config, socket, server, port, bind, ssl, ws) {
        socket.on('connection', stream => {
            ...
            client.on('publish', async packet => {
                ...
                if (adapter.config.debug) {
                    adapter.log.debug(`Client [${client.id}] received publish ${JSON.stringify(packet)}`);
                }
            ...
            client.on('pubrec', packet => {
                ...
                if (adapter.config.debug) {
                    adapter.log.debug(`Client [${client.id}] received pubrec ${JSON.stringify(packet)}`);
                }
            ...
            client.on('pubcomp', packet => {
                ...
                if (adapter.config.debug) {
                    adapter.log.debug(`Client [${client.id}] received pubcomp ${JSON.stringify(packet)}`);
                }
            ...
            client.on('pubrel', async packet => {
                ...
                if (adapter.config.debug) {
                    adapter.log.debug(`Client [${client.id}] received pubrel ${JSON.stringify(packet)}`);
                }
